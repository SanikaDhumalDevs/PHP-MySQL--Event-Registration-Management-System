        ...
        while ($row = $res->fetch_assoc()) {
			...
			echo "<td>" . $sr_no++ . "</td>";
                ...
                echo"<td>{$row['event']}</td>";
				 ...
				 echo"<td>{$row['member_2_name']}</td>";
				 echo"<td>{$row['member_2_email']}</td>";
				 echo"<td>{$row['member_3_name']}</td>";
				 echo"<td>{$row['member_3_email']}</td>";
				 echo"<td>{$row['member_4_name']}</td>";
				 echo"<td>{$row['member_4_email']}</td>";
